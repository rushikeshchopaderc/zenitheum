...
const contactInfo = [
  ...
  {
    icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/b2ad3ed6d0f1b29d2ef33e124b71541dcb25f4b30ca617ba3bf05711bbb84b30?placeholderIfAbsent=true&apiKey=6996dc1fa2444cff9994ea13907adb22",
    title: "Our Hotline",
    content: "+91 7066497023",
  },
  {
    icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/fcdeca5bf5a18ec88e59b126ce08c198e12b5d571aeb0519ebb367a02c92dbb0?placeholderIfAbsent=true&apiKey=6996dc1fa2444cff9994ea13907adb22",
    title: "Mail Us",
    content:
    ...
    <div className="flex flex-wrap items-start w-full max-md:max-w-full">
      {contactInfo.map((info, index) => (
        ...
        >
          ...
          >
            <div
              data-layername={info.title.toLowerCase().replace(/\s/g, "")}
