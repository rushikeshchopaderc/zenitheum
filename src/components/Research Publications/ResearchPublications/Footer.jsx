      ...
      >
        ...
        >
          <div className="flex flex-col px-28 py-5 text-white border-r border-zinc-700 min-w-[240px] w-[649px] max-md:px-5 max-md:max-w-full">
            ...
            <p
              data-layername="zeniteumDescription"
            ...
            <div className="flex flex-wrap items-start w-full max-md:max-w-full">
              ...
              >
                ...
                >
                  <img
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/591aac6281e5fcf96f0ba8300198547829336ced37d56b146f58faa35e8355b1?placeholderIfAbsent=true&apiKey=6996dc1fa2444cff9994ea13907adb22"
                    alt="Phone icon"
                    className="object-contain self-stretch my-auto w-7 aspect-square"
                  />
                </div>
              ...
              >
                ...
                >
                  <img
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/f18f634d07e7c13f36e7db66a2509e934395667b7343902d360ecc3da30aadf2?placeholderIfAbsent=true&apiKey=6996dc1fa2444cff9994ea13907adb22"
                    alt="Email icon"
                    className="object-contain self-stretch my-auto w-7 aspect-square"
                  />
                </div>
          ...
          >
            {socialIcons.map((icon, index) => (
              <a
                ...
                aria-label={`Visit our ${icon.alt.split(" ")[0]} page`}
              >
