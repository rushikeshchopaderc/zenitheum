...
const Navbar = () => {
  ...
  return (
    ...
    >
      <nav
        className={"flex items-center justify-around text-center text-md tracking-widest leading-none uppercase whitespace-nowrap border-b bg-zinc-900 border-zinc-700 max-md:max-w-full text-white"}
      >
