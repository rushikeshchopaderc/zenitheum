...
import Image from "../../images/zenitheum.png"; 
...
const ServiceSection = () => {
  return (
    <section style ={{ backgroundImage: `url(${Image})`, backgroundSize: "cover", backgroundPosition: "center center", backgroundRepeat: "no-repeat", opacity: 0.8}} 
    className="flex flex-wrap gap-10 items-center pl-32 mt-3.5 w-full border-t border-b border-zinc-700 min-h-[1048px] max-md:pl-5 max-md:mr-2 max-md:max-w-full">
